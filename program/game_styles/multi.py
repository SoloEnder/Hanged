            ...
            while running == True:
                ...
                while enter_hidden_word == True:
                    ...
                    if hidden_word != "":
                        ...
                        if alph_error == True:
                            print("Le nombre mystère ne peut contenir que des lettres de l'alphabet et les caractères 'à','à','ä','é','è','ê','ë','ÿ','ù','ç','-', des apostrophes et '-' !")
